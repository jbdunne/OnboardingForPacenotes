...
//  Onboard
//
//  Created by Jason Dunne on 8/17/14.
//  Copyright (c) 2014 Mike Amaral. All rights reserved.
//

#import "AppDelegate.h"
#import "JVMenuRootViewController/JVMenuRootViewController.h"
#import "JVMenuRootViewController/JVMenuRootViewController.m"
...
- (OnboardingViewController *)generateFirstDemoVC {
    ...
    OnboardingContentViewController *secondPage = [OnboardingContentViewController contentWithTitle:@"Safer travels" body:@"Avoid dangerous weather conditions on the road." image:[UIImage imageNamed:@"cone"] buttonText:@"Connect With Facebook" action:^{
    ...
    OnboardingContentViewController *thirdPage = [OnboardingContentViewController contentWithTitle:@"Efficient trips" body:@"Know live traffic patterns before they throw you off." image:[UIImage imageNamed:@"yellow"] buttonText:@"Get Started" action:^{
